document.addEventListener('DOMContentLoaded', function() {
    console.log("Smartphone Price List Script v1.0.23 -- Graceful N/A Handling -- is running.");
    ...
    // ** THIS FUNCTION HAS BEEN REWRITTEN FOR THE REFINEMENT **
    function renderPhoneRow(phone, index) {
        // 1. Create an array to hold the spec list items.
        const specItems = [];

        // 2. Conditionally add each spec to the array if it's not 'N/A'.
        ...
        // 3. Join the array into a single HTML string.
        const specListHtml = specItems.join('');

        // 4. Build the final HTML, injecting the dynamic spec list.
        return `
